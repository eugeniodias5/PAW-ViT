...
from .adaptative_avgmax_pool import SelectAdaptivePool2d
...
class SEResNetBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1, downsample=None):
        ...
        self.conv1 = nn.Conv2d(inplanes, planes, kernel_size=1, bias=False, stride=1)
...
def seresnet50(layers=None, pretrained=False, num_classes=1000, in_chans=3, **kwargs):
